...
def evaluate():
    ...
    model = get_model("efficientnetv2_s", num_classes=5, pretrained=False)
    ...
    plot_confusion_matrix(cm, CLASS_NAMES, save_path="outputs/confusion_matrix_efficientnet.png")
